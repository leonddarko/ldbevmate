    ...
    return (
        <>
            ...
            <button
                ...
                className="absolute top-4 right-18 z-1000 
                            btn btn-md rounded-full 
                            backdrop-blur-2xl
                            bg-blue-100/30 border border-blue-100/40
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                name="companyName"
                                required
                                className="input input-sm bg-white/50 border border-none shadow rounded-full w-full"
